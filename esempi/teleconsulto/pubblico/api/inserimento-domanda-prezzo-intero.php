...
$post_fields = array(
    ...
    , "price" => "39.99" /* PREZZO DEL TELECONSULTO, IN FASE DI SALVATAGGIO VIENE CONTROLLATA LA CORRETTEZZA DEL DATO*/
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "https://auth.paginemediche.it/api/1.0/tc-add-new-question");
